# Change Log for O3-Shop Wave Theme
...
### Changed
- footer legal-guarantee notice is always visible instead of behind a click-to-reveal
  (matches o3-theme #49); `_guarantee.scss` re-imported in `style.scss`
